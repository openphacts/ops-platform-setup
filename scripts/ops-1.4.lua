-- b414d5fb327cb44faf0f1191667d9804 http://api.2445580102272.proxy.3scale.net:80 https://beta.openphacts.org:443 1006371755042 beta.openphacts.org --
-- -*- mode: lua; -*-
-- Generated on: 2014-03-24 10:48:46 +0000 --
-- Version:
-- Error Messages per service

      service_1006371755042 = {
...
matched_rules2 = ""
        ...
        function extract_usage_1006371755042(request)
...
function get_debug_value()
   ...
   if h["X-3scale-debug"] == 'b414d5fb327cb44faf0f1191667d9804' then
      return true
   else
      return false
   end
...
local service = {}
      if ngx.var.service_id == '1006371755042' then
        ...
        get_credentials_app_id_app_key(params, service_1006371755042)
        ngx.var.cached_key = "1006371755042" .. ":" .. params.app_id ..":".. params.app_key
              auth_strat = "2"
        ngx.var.service_id = "1006371755042"
        ngx.var.proxy_pass = "http://backend_ops2.few.vu.nl"
        ngx.var.usage = extract_usage_1006371755042(ngx.var.request)
      end
