...
extract_links() {
    ...
    curl "http://sparql.wikipathways.org/?default-graph-uri=&query=CONSTRUCT+%7B%3FwpIdentifier+skos%3ArelatedMatch+%3FpathwayOntology+.%7D+%0D%0AWHERE+%7B%0D%0A++%3Fpathway+wp%3ApathwayOntologyTag+%3FpathwayOntology+.%0D%0A++%3Fpathway+dc%3Aidentifier+%3FwpIdentifier+.%0D%0A++FILTER+regex%28%3FpathwayOntology%2C+%22PW_%22%2C+%22i%22%29+%0D%0A%7D&format=text%2Frdf%2Bn3&timeout=0&debug=on" >> $OUTPUT_LINKSET_FILE
